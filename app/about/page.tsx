  ...
  return <main>
    ...
    <section className="grid-bg" style={{padding:"140px 0 100px",position:"relative",overflow:"hidden"}}>
      <div className="shell">
        ...
        <div style={{display:"flex",gap:12,marginTop:35,flexWrap:"wrap"}}><Link href="#rfp" className="btn">Discuss your website</Link><Link href="/case-studies" className="btn ghost">View case studies</Link></div>
      </div>
    </section>
