...
export const blogContent: Record<string, BlogBlock[]> = {
  ...
  "website-maintenance-checklist-for-nonprofits": [
    ...
    { type: "h2", text: "Add WordPress-specific checks where relevant" },
    { type: "p", content: ["For nonprofit WordPress websites, include core, theme, and plugin compatibility, license status, editor access, form delivery, scheduled tasks, backups outside the CMS, and staging workflow in the maintenance plan. These checks reduce the risk that a routine update disrupts donations, events, volunteer forms, or publishing."] },
    { type: "p", content: ["Teams that need ongoing help can combine nonprofit website care with dedicated ", { text: "WordPress maintenance and support", href: "/services/wordpress-support" }, "."] },
  ],
