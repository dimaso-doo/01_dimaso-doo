...
function RelatedServiceLinks({type}:{type:ServiceKey}) {
 const links:Record<ServiceKey,readonly (readonly [string,string])[]>={
  maintenance:[["Website maintenance costs and pricing","/blog/website-maintenance-costs-and-pricing"],["How to choose a maintenance partner","/blog/how-to-choose-a-website-maintenance-partner"],["Why QA matters after updates","/blog/why-qa-matters-after-every-update"],["Maintenance reporting guide","/blog/what-good-website-maintenance-reporting-looks-like"]],
