...
function RelatedServiceLinks({type}:{type:ServiceKey}) {
 const links:Record<ServiceKey,readonly (readonly [string,string])[]>={
  maintenance:[["Website maintenance costs and pricing","/blog/website-maintenance-costs-and-pricing"],["How to choose a maintenance partner","/blog/how-to-choose-a-website-maintenance-partner"],["Nonprofit website maintenance checklist","/blog/website-maintenance-checklist-for-nonprofits"],["Maintenance reporting guide","/blog/what-good-website-maintenance-reporting-looks-like"]],
